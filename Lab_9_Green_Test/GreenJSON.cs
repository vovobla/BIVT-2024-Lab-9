...
namespace Lab_9_GreenJSON
{
    [TestClass]
    public sealed class GreenJSON
    {
        private Random _rand = new Random();
        GreenSerializer _serializer = new GreenJSONSerializer();
        ...
        public void Test_01_Hierarchy()
        {
            ...
            Assert.IsFalse(_serializer is GreenTXTSerializer);
            Assert.IsTrue(_serializer is GreenJSONSerializer);
        }
        [TestMethod]
        public void Test_02_CreateFolder()
        {
            Assert.IsTrue(IFileManagerTest.Check_CreateFolder(_serializer, $"Green_JSON"));
            CheckFolder();
        }
        [TestMethod]
        public void Test_03_CreateFile()
        {
            Assert.IsTrue(IFileManagerTest.Check_CreateFile(_serializer, $"Green_JSON", $"Green_task", "json"));
            CheckFile();
        }
        [TestMethod]
        public void Test_04_Green1_JSON()
        {
            Init();
            Test_03_CreateFile();
        ...
        [TestMethod]
        public void Test_05_Green2_JSON()
        {
            Init();
            Test_03_CreateFile();
        ...
        [TestMethod]
        public void Test_06_Green3_JSON()
        {
            Init();
            Test_03_CreateFile();
        ...
        [TestMethod]
        public void Test_07_Green4_JSON()
        {
            Init();
            Test_03_CreateFile();
        ...
        [TestMethod]
        public void Test_08_Green5_JSON()
        {
            Init();
            Test_03_CreateFile();
        ...
        private void Init()
        {
            _serializer = new GreenJSONSerializer();
        }
        private void CheckFolder()
        {
            var pathes = IFileManagerTest.Check_Properties(_serializer);
            Assert.AreEqual(pathes.folder, Path.Combine(IFileManagerTest.GeneralPath, $"Green_JSON"));
        ...
        private void CheckFile()
        {
            var pathes = IFileManagerTest.Check_Properties(_serializer);
            Assert.AreEqual(pathes.folder, Path.Combine(IFileManagerTest.GeneralPath, $"Green_JSON"));
            Assert.AreEqual(pathes.file, Path.Combine(IFileManagerTest.GeneralPath, $"Green_JSON", $"Green_task.json"));
        }
