...
namespace Lab_9_WhiteJSON
{
    [TestClass]
    public sealed class WhiteJSON
    {
        private Random _rand = new Random();
        WhiteSerializer _serializer = new WhiteJSONSerializer();
        ...
        public void Test_01_Hierarchy()
        {
            ...
            Assert.IsTrue(_serializer is WhiteJSONSerializer);
            Assert.IsFalse(_serializer is WhiteTXTSerializer);
        }

        [TestMethod]
        public void Test_02_CreateFolder()
        {
            Assert.IsTrue(IFileManagerTest.Check_CreateFolder(_serializer, $"White_JSON"));
            CheckFolder();
        }
        ...
        {
            Assert.IsTrue(IFileManagerTest.Check_CreateFile(_serializer, $"White_JSON", $"White_task", "JSON"));
            CheckFile();
        }

        [TestMethod]
        public void Test_04_White1_JSON()
        {
            Init();
            Test_03_CreateFile();
        ...
        [TestMethod]
        public void Test_05_White2_JSON()
        {
            Init();
            Test_03_CreateFile();
        ...
        [TestMethod]
        public void Test_06_White3_JSON()
        {
            Init();
            Test_03_CreateFile();
        ...
        [TestMethod]
        public void Test_07_White4_JSON()
        {
            Init();
            Test_03_CreateFile();
        ...
        [TestMethod]
        public void Test_08_White5_JSON()
        {
            Init();
            Test_03_CreateFile();
        ...
        private void Init()
        {
            _serializer = new WhiteJSONSerializer();
        }
        private void CheckFolder()
        {
            var pathes = IFileManagerTest.Check_Properties(_serializer);
            Assert.AreEqual(pathes.folder, Path.Combine(IFileManagerTest.GeneralPath, $"White_JSON"));
        ...
        private void CheckFile()
        {
            var pathes = IFileManagerTest.Check_Properties(_serializer);
            Assert.AreEqual(pathes.folder, Path.Combine(IFileManagerTest.GeneralPath, $"White_JSON"));
            Assert.AreEqual(pathes.file, Path.Combine(IFileManagerTest.GeneralPath, $"White_JSON", $"White_task.json"));
        }
